                ...
                <div class="xjhy">
                    ...
                    <ul class="hypz gjpz clearfix">
                        <li class="clearfix">
                            ...
                            <div class="li_r">
                                <input class="chang" name="name" type="text" value="${OBJ.account}"/>
                                <i>*</i>
                            </div>
                        </li>
                        <li class="clearfix">
                        ...
                        <li class="clearfix">
                            ...
                            <div class="li_r">
                                <input class="chang" name="address" type="text" value="${OBJ.name}"/>
                            </div>
                        </li>
                        <li class="clearfix">
                        ...
                        <li class="clearfix">
                            ...
                            <div class="li_r">
                                <input class="chang" name="address" type="text" value="${OBJ.idNumber}"/>
                            </div>
                        </li>
                        <li class="clearfix">
                            <span class="title">出生日期：</span>
                            <div class="li_r">
                                <input class="chang" name="address" type="text" value="<fmt:formatDate value="${OBJ.bornDate}" pattern="yyyy-MM-dd"/>"/>
                            </div>
                        </li>
                        <li class="clearfix">
